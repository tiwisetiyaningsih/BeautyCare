...
class DetailHair extends StatelessWidget {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
                ...
                child: Div.col([
                    ...
                    Padding(
                      ...
                      child: Image(
                      image: AssetImage('assets/image_hair_coloring.png',),
                      width: 400,
            ...
            Padding(
              ...
              child: Text("Hair coloring is a practice of changing hair color. The main reason is for beauty, to cover gray or white hair, to change a color that is considered more desirable or fashionable, or to restore the original hair color after it has faded due to the hair styling process or the influence of sunlight.",
              style: TextStyle(
